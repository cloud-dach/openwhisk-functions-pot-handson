...
2. OpenWhisk als Compute Modell
3. OpenWhisk Working with Actions
4. OpenWhisk Working with Sequences
5. OpenWhisk Working with Rules
6. OpenWhisk Working with extend Sequence
7. OpenWhisk Working with Trigger and Rules
...
---
### 2. **OpenWhisk (Functions) als Compute Modell**
